...
%>
	...
	<table class="table">
		<tr>
			<td>글번호</td><td><input type="text" name="nid" value="<%=vo.getNoticeId() %>"></td>
			<td>조회수 [<b><%=vo.getHitCount() %></b>]</td>
		</tr>
		<tr>
			<td>제목</td>
			<td><input type="text" name="title" value="<%=vo.getNoticeTitle() %>"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<input type="text" name="attach" value="<%=vo.getAttach() %>"></td>
			<%} else {%>
